...
ActiveRecord::Schema[7.0].define(version: 2021_11_23_090248) do
  ...
  create_table "calendar_dates", force: :cascade do |t|
    ...
    t.datetime "caretaker_informed_at"
    t.datetime "caretaker_confirmed_light_at"
    t.datetime "caretaker_dismissed_light_at"
